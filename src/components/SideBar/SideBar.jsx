  ...
  return (
    <>
      <header className="flex justify-between items-center p-7 text-sm text-gray-500 md:justify-center md:ml-60 border-b border-grey-400">
        ...
        <span className="text-xl truncate text-black">Design Custom</span>
        <span></span>
      </header>
      ...
      <aside
        id="logo-sidebar"
        ref={sidebarRef}
        className={`fixed top-0 left-0 z-40 bg-gray-500 h-full w-60 transition-transform md:translate-x-0 ${
