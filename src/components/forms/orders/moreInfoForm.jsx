    ...
    >
      <Box className="flex flex-col">
        ...
        <Input
          ...
          disabled
          value={order.user.address.region}
        />
        <Input placeholder="Город" disabled value={order.user.address.city} />
        <Input
          placeholder="Почтовый индекс"
          disabled
          value={order.user.address.index}
        />
        <Input
          placeholder="Адрес"
          disabled
          value={order.user.address.address}
        />
      </Box>
